    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-7">
                ...
                <h1 class="mb-5 display-3 text-primary">Chào mừng đến với LaptopShop</h1>
                <p class="mb-4 text-secondary">Tìm kiếm những chiếc laptop và phụ kiện tốt nhất tại đây</p>
                <div class="position-relative mx-auto">
                    ...
                    <button type="submit"
                        ...
                        style="top: 0; right: 25%;">Tìm kiếm ngay</button>
                </div>
            </div>
